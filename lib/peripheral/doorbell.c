...
static ssize_t read_doorbell_ring(
        struct bt_conn *conn,
...
// Format constants see https://www.bluetooth.com/specifications/assigned-numbers/
// PDF Sec 2.4 characteristic presentation format.
...
BT_GATT_SERVICE_DEFINE(
    ...
    BT_GATT_CHARACTERISTIC(
        BT_UUID_BLUE_CAT_DOORBELL_RING,
        BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
        BT_GATT_PERM_READ_AUTHEN, &read_doorbell_ring, NULL, NULL),
